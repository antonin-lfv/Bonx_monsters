...
class GameConfig(Config):
    ...
    COMMON_RATIO_CARD_TO_UPGRADE: ratio of common cards to upgrade defense and attack
    ...
    RARE_RATIO_CARD_TO_UPGRADE: ratio of rare cards to upgrade defense and attack
    ...
    EPIC_RATIO_CARD_TO_UPGRADE: ratio of epic cards to upgrade defense and attack
    ...
    MONSTER_CONGIF = {
        ...
        "Rare": {
            ...
            "Ratio of Cards to Upgrade": 1.25
        },
        "Epic": {
            "Defense": 50,
            "Attack": 60,
        ...
        "Legendary": {
            ...
            "Ratio of Cards to Upgrade": 1.15
        }
    }
